...
def gerar_pdf_abnt(data, filepath, logo_path=None):  # noqa: C901
    ...
    def _on_conteudo(c, doc):
        ...
        NBR 14724:2024 §5.3: a 2 cm da borda superior, último algarismo a 2 cm da direita."""
    ...
    # Seções — NBR 14724:2024 §5.2.2: cada seção primária começa em nova página
    ...
    # Referências — NBR 14724:2024 §5.2.3: título centralizado, sem indicativo numérico
    # §5.2: espaço simples, separadas entre si por linha em branco
    if referencias:
        refs_bloco = [PageBreak(), Paragraph("REFERÊNCIAS", estilos["resumo_titulo"]),
                      Spacer(1, 0.3 * cm)]
